// WGSL kernels — copied verbatim from src/webgpu_shaders.h. The dot kernel
// uses workgroup-shared partial sum + atomic CAS on a u32-cast f32 (WGSL
// has no f32 atomics).

pub const ADD_WGSL: &str = r#"
